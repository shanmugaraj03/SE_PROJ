  ...
  return (
    <html lang="en">
      ...
      <body>
              ...
              <nav className="navbar navbar-expand-lg navbar-dark">
                ...
                <div
                  ...
                  <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item">
                      <a className="nav-link" href="#bot1">
                        Contact 
                      </a>
                    </li> 
                    <li>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="don-box">
                  ...
                  <a href="/Transport1" className="btn1">
                    Details
                  </a><br />
                </div>
              </div>
              ...
              <div className="col-lg-4">
                <div className="don-box">
                  ...
                  <a href="/Trekking1" className="btn1">
                      Details
                  </a>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="don-box">
                  ...
                  <a href="/LocSpot1" className="btn1">
                    Details
                  </a>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="don-box">
                  ...
                  <a href="/CampFire1" className="btn1">
                    Details
                  </a>
                </div>
              </div>
        ...
        <footer>
        <section className="bottom-sec" id="bot1">
          <div className="container">
            <div className="row">
              <div className="col-lg-4">
